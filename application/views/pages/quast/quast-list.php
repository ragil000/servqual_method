      ...
      <div class="card-header border-0">
        <div class="row">
          ...
          <div class="col-lg-9 text-left">
            <a href="<?=base_url('quast/createQuast/')?>" class="btn btn-primary"><i class="ni ni-single-copy-04"></i> Tambah</a>
          </div>
        </div>
      </div>
      <div class="table-responsive">
        ...
        <table class="table align-items-center table-flush">
          ...
          <tbody>
              ...
              ?>
              <tr>
                  <td><?=_limitText($value->title, 80)?></td>
                  <td><a href="<?=$value->link?>"></a><?=_limitText($value->link, 80)?></td>
                  <td><?=$value->status == 'active' ? '<span class="badge badge-success">aktif</span>' : '<span class="badge badge-danger">tidak aktif</span>'?></td>
                  <td class="text-right">
