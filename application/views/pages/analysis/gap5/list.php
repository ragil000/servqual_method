                        ...
                        <div class="card shadow">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-9 text-right">
                                        <a href="<?= base_url('analysis/gap5') ?>" class="btn btn-warning"><i class="ni ni-bold-left"></i> Kembali</a>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive">
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col" rowspan="2">Kriteria/Pertanyaan</th>
                                            <!-- <th scope="col" rowspan="2">Dimensi</th> -->
                                            ...
                                            <th scope="col" rowspan="2">Nilai GAP 5</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= $value->sum_expectation_answer ?></td>
                                                    <td class="text-center"><?= $expectation_average ?></td>
                                                    <td class="text-center"><?= $value->sum_reality_answer ?></td>
                                                    <td class="text-center"><?= $reality_average ?></td>
