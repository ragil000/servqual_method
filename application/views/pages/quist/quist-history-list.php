        ...
        <table class="table align-items-center table-flush">
          <thead class="thead-light">
            <tr>
              ...
              <th scope="col">Total Jawaban Benar</th>
              <th scope="col"></th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr>
                  ...
                  <td class="text-right">
                      ...
                      <a href="<?=base_url('/quist/detailHistory/'.$value->user_id)?>" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>
